...
resource "aws_cloudwatch_metric_alarm" "cpu_utilization_too_high" {
  ...
  alarm_name          = "${local.identifier}-rds-${var.db_instance_id}-highCPUUtilization"
...
resource "aws_cloudwatch_metric_alarm" "cpu_credit_balance_too_low" {
  ...
  alarm_name          = "${local.identifier}-rds-${var.db_instance_id}-lowCPUCreditBalance"
...
resource "aws_cloudwatch_metric_alarm" "disk_queue_depth_too_high" {
  ...
  alarm_name          = "${local.identifier}-rds-${var.db_instance_id}-highDiskQueueDepth"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = var.evaluation_period
...
resource "aws_cloudwatch_metric_alarm" "disk_free_storage_space_too_low" {
  ...
  alarm_name          = "${local.identifier}-rds-${var.db_instance_id}-lowFreeStorageSpace"
  comparison_operator = "LessThanThreshold"
  evaluation_periods  = var.evaluation_period
...
resource "aws_cloudwatch_metric_alarm" "disk_burst_balance_too_low" {
  ...
  alarm_name          = "${local.identifier}-rds-${var.db_instance_id}-lowEBSBurstBalance"
  comparison_operator = "LessThanThreshold"
  evaluation_periods  = var.evaluation_period
...
resource "aws_cloudwatch_metric_alarm" "memory_freeable_too_low" {
  ...
  alarm_name          = "${local.identifier}-rds-${var.db_instance_id}-lowFreeableMemory"
  comparison_operator = "LessThanThreshold"
  evaluation_periods  = var.evaluation_period
...
resource "aws_cloudwatch_metric_alarm" "memory_swap_usage_too_high" {
  ...
  alarm_name          = "${local.identifier}-rds-${var.db_instance_id}-highSwapUsage"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = var.evaluation_period
...
resource "aws_cloudwatch_metric_alarm" "connection_count_anomalous" {
  ...
  alarm_name          = "${local.identifier}-rds-${var.db_instance_id}-anomalousConnectionCount"
